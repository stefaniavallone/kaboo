...
# requirements.source.setup = ../../setup,
...
# (str) python-for-android fork to use, defaults to upstream (setup)
#p4a.fork = setup
...
# (str) Path to a custom setup-ios folder
#ios.kivy_ios_dir = ../setup-ios
